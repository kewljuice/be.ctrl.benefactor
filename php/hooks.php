 ...
 * CiviCRM hooks
 */
function benefactor_civicrm_navigationMenu(&$params) {
  ...
  $child = array(
    'attributes' => array(
      'label' => 'Benefactor',
      'name' => 'ctrl_benefactor',
      'url' => 'civicrm/ctrl/benefactor',
      'permission' => 'access CiviCRM',
      'operator' => NULL,
      'separator' => 0,
      'parentID' => $ParentKey,
  ...
  $params[$AdministerKey]['child'][$ParentKey]['child']['ctrl_benefactor'] = $child;
}
